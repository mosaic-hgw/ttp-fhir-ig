...
Alias: $csExampleOptOut = https://ths-greifswald.de/fhir/CodeSystem/gics/Policy/opt-out
...
Alias: $csTemplateType = http://fhir.de/ConsentManagement/CodeSystem/TemplateType
