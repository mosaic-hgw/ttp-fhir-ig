...
* kind = #operation
* description = "Nimmt die Einwilligungsinformationen einschließlich Nebeninformationen für einen (ggf. neuen) Patienten entgegen. Liefert die hieraus errechneten strukturierten Consents der Person."
